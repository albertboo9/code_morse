# -*- coding: cp1252 -*-
code=[
  ".-", #'A' = .-  code[0] correspond au caractere acsii 65
  "-...",  "-.-.","-..",  ".",  "..-.",  "--.","....","..",
  ".---","-.-",".-..","--","-.","---",".--.","--.-",".-.","...",
  "-","..-","...-",".--","-..-","-.--","--..",
  "-----",#'0' code [26] correspond au caractere ascii 48
  ".----","..---","...--","....-",".....","-....","--...","---..","----."] #end string code
ascii="ABCDEFGHIJKLMNOPQRSTUVWXYZ0123456789" # tableau ascii correspondant au tableau code
xx=""".--. --- ..- .-.  ...- .- .-.. .. -.. . .-.  .. .-..  - .  ... ..- ..-. ..-. .. -  -.. .  - .- .--. . .-.  ... .- -- ..- . .-..  ... ..- .. ...- ..  -.. .  ... --- -.  -. --- --  -.. .  ..-. .- -- .. .-.. .-.. .  .-.. .  - --- ..- -  .- - - .- -.-. .... .  . -  . -.  -- .. -. ..- ... -.-. ..- .-.. . ...  """
import winsound
import time
def point():
...
def joue(x):                                    #jouer et traduire un code morse (dans x='-- ..
      ...
      message=""
      messagePartiel=""
      affichage=""                                    #message affich� � l'�cran
      debut=False
